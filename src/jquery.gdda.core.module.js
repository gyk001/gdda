...
*/
	...
	var _render_module = function(context, data) {
		var moduleType = context.options.type || 'nope';
		var moduleImpl = _gdda.module[moduleType];
		return _util.buildDeferred(moduleImpl.render, _renderModuleDoneCallbacks,
			_renderModuleFailCallbacks, context, data);
		};
